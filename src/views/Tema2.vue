<template lang="pug">
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      p.mb-5 Node.js por sí solo no impone una estructura para gestionar rutas ni peticiones HTTP. En la industria, esa responsabilidad recae sobre el framework Express, una capa ligera que organiza la lógica del servidor sin agregar complejidad innecesaria al proyecto.
      ...
      p.mb-5 A continuación, se crea el archivo #[b.text-cus-2 index.js], el punto de entrada de la aplicación:
      ...
      p.mb-5 El servidor HTTP construido en la sección anterior resuelve eficientemente las peticiones tradicionales: un cliente pregunta, el servidor responde y la conexión se cierra. Sin embargo, este modelo tiene un límite estructural que lo hace inviable para aplicaciones en tiempo real: el servidor jamás puede iniciar una conversación; siempre espera a que el cliente dé el primer paso.  
      ...
      p.mb-3 Se modifica el archivo #[b.text-cus-2 index.js] para agregar la capa de WebSockets mediante socket.io:
      p.mb-5 A continuación, se describe el análisis crítico de cada bloque:
      ...
      p.mb-0 PEND          
      p.mb-5 Elegir incorrectamente entre estas cuatro opciones produce errores de lógica difíciles de detectar: mensajes que no llegan, mensajes duplicados o usuarios que reciben información que no les corresponde.    
